...
CREATE TABLE discogs.artists_image(
    artist_id integer,
    type text,
    height integer,
    width integer,
...
CREATE TABLE discogs.labels_images (
    label_id integer,
    type text,
    height integer,
    width integer,
...
CREATE TABLE discogs.masters_artists_joins (
    artist1 text,
    artist2 text,
    join_relation text,
    master_id integer);

CREATE TABLE discogs.masters_extraartists (
    master_id integer,
    artist_name text,
    roles text[]);

CREATE TABLE discogs.masters_formats (
    master_id integer,
    format_name text,
    qty integer,
    descriptions text[]);

CREATE TABLE discogs.masters_images (
...
CREATE TABLE discogs.releases_artists (
...
CREATE TABLE discogs.releases_formats (
    release_id integer NOT NULL,
    "position" integer NOT NULL,
    format_name text,
    qty numeric(100,0),
...
CREATE TABLE discogs.releases_images (
    release_id integer NOT NULL,
    type text NOT NULL,
    height integer,
    width integer,
...
CREATE TABLE discogs.track_artists (
    track_id text NOT NULL,
    "position" integer NOT NULL,
    artist_id integer,
    artist_name text,
...
CREATE TABLE discogs.tracks_extraartists (
    track_id text,
    artist_id integer,
    artist_name text,
    anv text,
