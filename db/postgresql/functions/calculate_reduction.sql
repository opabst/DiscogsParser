CREATE OR REPLACE FUNCTION discogs.calculate_reduction() RETURNS VOID AS $$
DECLARE
...
BEGIN
    ...
    LOOP
        ...
        INSERT INTO discogs.processing_results (import_table, import_tuple_count, transformed_table, transformed_tuple_count, reduction_cnt, reduction_pct)
